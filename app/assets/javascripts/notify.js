...
(function($){
	...
	*/
    ...
    $.gritter.change = function(number, params){
        Gritter.change(number, params || {});
    }
	...
	*/
	var Gritter = {
        ...
        _tpl_item_bl: '<div class="gritter-top"></div><div class="gritter-item">[[close]][[image]]<div class="[[class_name]]"><span class="gritter-title">[[username]]</span><p>[[text]]</p></div><div style="clear:both"></div></div><div class="gritter-bottom"></div>',
		...
		*/
        ...
        change: function(number, params){

            var item = $('#gritter-item-' + number).first();

            if (!item.get(0)) return Gritter.add(params || {});
