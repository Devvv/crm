...
class AbstractChosen
  ...
  set_default_text: ->
    if @form_field.getAttribute("data-placeholder")
      ...
      @default_text = @options.placeholder_text_multiple || @options.placeholder_text || "Введите имя"
    else
      @default_text = @options.placeholder_text_single || @options.placeholder_text || "Введите имя"

    @results_none_found = @form_field.getAttribute("data-no_results_text") || @options.no_results_text || "Не совпадений"
...
class Chosen extends AbstractChosen
  ...
  set_up_html: ->
    ...
    if @is_multiple
      container_div.html '<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + @default_text + '" class="default" autocomplete="off" style="width:25px;" /><li class="search-more">Еще</li><li class="search-close">Закрыть</li></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>'
    else
    ...
    $('.search-close').bind('mousedown', ->

        $(document).trigger "click", @click_test_action
